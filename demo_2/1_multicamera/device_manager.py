...
class DeviceManager:
    ...
    def enable_advanced_mode(self, path):
        with open(path) as f:
...
if __name__ == "__main__":
    ...
    fpce = face.FacePointCloud(manual_adjustments=False)
    ...
    try:
        ...
        for i in range(num_frames):
            ...
            fpce.create_from_rgbd(left_rgb, left_d, f"frames/device_left/{i+1}.ply")
            fpce.create_from_rgbd(right_rgb, right_d, f"frames/device_right/{i+1}.ply")
